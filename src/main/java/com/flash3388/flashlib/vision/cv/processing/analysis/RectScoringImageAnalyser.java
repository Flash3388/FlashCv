...
public class RectScoringImageAnalyser implements ImageAnalyser<CvImage> {
    ...
    public static class Builder {
        ...
        public RectScoringImageAnalyser build() {
            return new RectScoringImageAnalyser(mCvProcessing,
    ...
    public RectScoringImageAnalyser(CvProcessing cvProcessing, Predicate<? super Rect> rectFilter,
                                    Function<? super Rect, ? extends Scorable> scorableFactory,
    ...
    public Analysis analyse(CvImage image) throws ImageAnalysingException {
        ...
        if (!bestFind.isPresent()) {
            // or return empty analysis
            throw new ImageAnalysingException();
        }

        Scorable scorable = bestFind.get();
        return mAnalysisFactory.apply(image, scorable);
    }
